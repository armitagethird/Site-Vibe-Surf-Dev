...
const I18N = {
  pt: {
    ...
    'markets.eyebrow': 'Para o seu mercado',
    'markets.h2.l1': 'Páginas pensadas',
    'markets.h2.l2': 'por nicho',
    'markets.h2.l3': '.',
    'markets.intro': 'Mesmo ofício, ângulo diferente. Veja como aplicamos a engenharia em mercados específicos — e fale com a gente se o seu não estiver aqui.',
    'markets.cta': 'Ver página →',
    'markets.m1.eyebrow': 'MÉDICOS',
    'markets.m1.title': 'Sites para consultório próprio',
    'markets.m1.desc': 'Site institucional + questionário que filtra o paciente antes da primeira consulta.',
    'markets.m2.eyebrow': 'SISTEMAS',
    'markets.m2.title': 'Software sob medida',
    'markets.m2.desc': 'Quando sua operação não cabe num SaaS genérico. ProntuVet + Motel Paraíso em produção.',
    'markets.m3.eyebrow': 'CLÍNICAS VET',
    'markets.m3.title': 'ProntuVet',
    'markets.m3.desc': 'IA escuta a consulta e devolve o prontuário estruturado em segundos.',
    'markets.m4.eyebrow': 'MOTÉIS',
    'markets.m4.title': 'Motel Paraíso',
    'markets.m4.desc': 'Site público + sistema local + dashboard remota com IA. Operação na mão, de qualquer lugar.',
    'markets.any.eyebrow': 'Não vê seu mercado?',
    'markets.any.h3.a': 'Fazemos sistema para',
    'markets.any.h3.b': 'qualquer operação',
    'markets.any.h3.c': '.',
    'markets.any.h3.d': 'Aceitamos',
    'markets.any.h3.e': 'qualquer desafio',
    'markets.any.h3.f': '.',
    'markets.any.body': 'Os nichos acima são só os que já têm página pronta. Se você tem uma operação manual que precisa virar software — clínica, escola, escritório, distribuidora, indústria, eventos, qualquer coisa — fale com a gente. Mesma engenharia, ângulo novo.',
    'markets.any.cta': 'Falar do meu projeto',
  ...
  en: {
    ...
    'markets.eyebrow': 'For your market',
    'markets.h2.l1': 'Pages tuned',
    'markets.h2.l2': 'by niche',
    'markets.h2.l3': '.',
    'markets.intro': "Same craft, different angle. See how we apply the engineering across specific markets — and reach out if yours isn't here yet.",
    'markets.cta': 'See page →',
    'markets.m1.eyebrow': 'DOCTORS',
    'markets.m1.title': 'Sites for private practices',
    'markets.m1.desc': 'Marketing site + intake questionnaire that filters the patient before the first consult.',
    'markets.m2.eyebrow': 'SYSTEMS',
    'markets.m2.title': 'Custom-built software',
    'markets.m2.desc': "When your operation doesn't fit a generic SaaS. ProntuVet + Motel Paraíso in production.",
    'markets.m3.eyebrow': 'VET CLINICS',
    'markets.m3.title': 'ProntuVet',
    'markets.m3.desc': 'AI listens to the consultation and returns the structured medical record in seconds.',
    'markets.m4.eyebrow': 'MOTELS',
    'markets.m4.title': 'Motel Paraíso',
    'markets.m4.desc': 'Public site + on-premise system + AI remote dashboard. Operation in hand, from anywhere.',
    'markets.any.eyebrow': "Don't see your market?",
    'markets.any.h3.a': 'We build software for',
    'markets.any.h3.b': 'any operation',
    'markets.any.h3.c': '.',
    'markets.any.h3.d': 'We take',
    'markets.any.h3.e': 'any challenge',
    'markets.any.h3.f': '.',
    'markets.any.body': "The niches above are just the ones with pages ready. If you have a manual operation that needs to become software — clinic, school, office, distributor, factory, events, anything — talk to us. Same engineering, fresh angle.",
    'markets.any.cta': 'Talk about my project',
